        ...
        <Portal>
          ...
          >
            ...
            >
              ...
              {/* People to send it to — a pinned search above the ONLY scrolling region */}
              {canDM ? (
                <>
              ...
              {/* Copy link / Share card / Share to… — pinned to the bottom so it stays
                  in view while the people grid scrolls above it */}
              <div className={`shrink-0 p-4 ${canDM ? 'border-t border-line bg-panel' : ''}`}>
