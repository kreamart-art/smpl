...
export const battleDetail = {
  en: {
    ...
    'battleDetail.claimSlot': 'Claim a slot',
    ...
    'battleDetail.voting.house': 'As the house, you don’t vote, it keeps every battle fair. You can still comment.',
    'battleDetail.voting.houseTag': 'House',
  ...
  nl: {
    ...
    'battleDetail.claimSlot': 'Claim een slot',
    ...
    'battleDetail.voting.house': 'als platform stem je niet, dat houdt elke battle eerlijk. reageren mag wel.',
    'battleDetail.voting.houseTag': 'platform',
