...
export const profile = {
  en: {
    ...
    'profile.gender.self': 'Prefer to self-describe',
    'profile.gender.undisclosed': 'Prefer not to say',
    'profile.gender.selfLabel': 'Self-describe',
    'profile.gender.selfPlaceholder': 'How you describe yourself',
    'profile.gender.privateNote': 'Only you can see this. It never shows on your profile.',
    ...
    // links manager
    'profile.manageLinks': 'Manage links',
    'profile.linkAdd': 'Add link',
    'profile.linkAddBtn': 'Add',
    'profile.linkUrl': 'URL',
    'profile.linkTitle': 'Title',
    'profile.linkTitlePh': 'e.g. SoundCloud',
    'profile.linksEmpty': 'No links yet.',
    'profile.linkBothRequired': 'Fill in both the URL and the title.',
    // competitor stats
  ...
  nl: {
    ...
    'profile.gender.man': 'Man',
    'profile.gender.nonbinary': 'Non-binair',
    'profile.gender.self': 'Zelf omschrijven',
    'profile.gender.undisclosed': 'Zeg ik liever niet',
    'profile.gender.selfLabel': 'Zelf omschrijven',
    'profile.gender.selfPlaceholder': 'Hoe je jezelf omschrijft',
    'profile.gender.privateNote': 'Alleen jij ziet dit. Het komt nooit op je profiel.',
    ...
    // links beheren
    'profile.manageLinks': 'Links beheren',
    'profile.linkAdd': 'Link toevoegen',
    'profile.linkAddBtn': 'Toevoegen',
    'profile.linkUrl': 'URL',
    'profile.linkTitle': 'Titel',
    'profile.linkTitlePh': 'bijv. SoundCloud',
    'profile.linksEmpty': 'Nog geen links.',
    'profile.linkBothRequired': 'Vul zowel de URL als de titel in.',
    // competitor stats
    'profile.stats.battles': 'battles',
