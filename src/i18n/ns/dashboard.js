...
export const dashboard = {
  en: {
    ...
    'dashboard.schedule.startAt': 'Signups open',
    'dashboard.schedule.startHint': 'leave empty to open now',
    'dashboard.schedule.summary': 'Runs {total} days once signups open, then you crown the winner.',
  ...
  nl: {
    ...
    'dashboard.schedule.startAt': 'Inschrijving opent',
    'dashboard.schedule.startHint': 'leeg = nu openen',
    'dashboard.schedule.summary': 'Loopt {total} dagen zodra de inschrijving opent, daarna kroon jij de winnaar.',
    'dashboard.wizard.step1': 'Type',
    ...
    'dashboard.manage.closeVoting': 'Stemmen sluiten & winnaar kronen',
    'dashboard.manage.closeHint.earliest': 'De meest gestemde inzending wint automatisch. Bij een exacte gelijkstand wint de vroegste inzending.',
    'dashboard.manage.closeHint.curator': 'De meest gestemde inzending wint automatisch. Bij een exacte gelijkstand kies je hieronder de winnaar.',
    'dashboard.manage.tiePick': 'Gelijkspel bovenaan, kies de winnaar',
    'dashboard.manage.tieHint': 'Deze inzendingen staan gelijk in stemmen. Kies de winnaar.',
    'dashboard.manage.pick': 'Kies winnaar',
